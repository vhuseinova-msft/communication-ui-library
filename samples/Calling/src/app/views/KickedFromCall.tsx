 ...
 */
export const JustForAnjul1 = (props: { title: string; moreDetails?: ReactNode; icon?: ReactNode }): JSX.Element => (
  <Stack verticalFill verticalAlign="center" horizontalAlign="center">
    <Stack className={mergeStyles(containerStyle)} tokens={containerItemGap}>
      ...
      <img width={'300px'} src="https://media.giphy.com/media/xUA7aTBBzucioSlFcY/giphy.gif" alt="" />
