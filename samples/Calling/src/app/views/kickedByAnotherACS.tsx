 ...
 */
export const JustForAnjul3 = (props: { title: string; moreDetails?: ReactNode; icon?: ReactNode }): JSX.Element => (
  <Stack verticalFill verticalAlign="center" horizontalAlign="center">
    <Stack className={mergeStyles(containerStyle)} tokens={containerItemGap}>
      ...
      <img
        width={'300px'}
        src="https://media.giphy.com/media/xUA7aTBBzucioSlFcY/giphy.gif?cid=ecf05e4795j0az2wa9iqq4xgvcf1ewwjpd0sqtf3i144hr8m&rid=giphy.gif&ct=g"
        alt=""
      />
