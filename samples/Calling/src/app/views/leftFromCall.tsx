 ...
 */
export const JustForAnjul2 = (props: { title: string; moreDetails?: ReactNode; icon?: ReactNode }): JSX.Element => (
  <Stack verticalFill verticalAlign="center" horizontalAlign="center">
    <Stack className={mergeStyles(containerStyle)} tokens={containerItemGap}>
      ...
      <img width={'300px'} src="https://media.giphy.com/media/3oEjHSNWEQN0DbSULu/giphy.gif" alt="" />
